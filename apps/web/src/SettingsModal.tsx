...
type SettingsSection = 'appearance' | 'libraries' | 'notifications' | 'diagnostics'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <nav className="settings-sections detail-tabs" aria-label="Settings sections">
          ...
          <>
            ...
            <section className="settings-section">
              ...
              <p className="muted">
                ...
                attach up to {REFINE_SNIPPET_MAX_PHOTOS} photos and{' '}
                {REFINE_SNIPPET_MAX_MESHES} meshes (32 MB each). Custom attachments are stored
                in this browser.
              </p>
              <ul className="template-list">
                {snippets.map((s) => (
              ...
              <form className="template-form" onSubmit={(e) => void onSaveSnippet(e)}>
                <label className="template-field">
                  ...
                  <input
                    value={snipTitle}
                    onChange={(e) =>
                      setSnipTitle(e.target.value.slice(0, REFINE_TITLE_MAX))
                    }
                ...
                <label className="template-field">
                  ...
                  <textarea
                    value={snipPrompt}
                    onChange={(e) =>
                      setSnipPrompt(e.target.value.slice(0, REFINE_PROMPT_MAX))
                    }
                    rows={4}
                    required
